...
module.exports = function(app) {
    ...
    // like the hot restaurant example.  Had help from some tutor, but still lost.
	...
	app.post('/api/friends', function(req, res) {
	    ...
	    //for best match start by looping through the first of the friends in the friendsArray
